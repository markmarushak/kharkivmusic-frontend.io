...
for(i = 0; i <= 12; i++){
                    ...
                    if(settings.sundayFirst) {
                        ...
                        if($(document).width() < 768){
                            ...
                            for(i = 1; i < 8; i++) {
                                if(i < 7) {
                                    html += '<td>' + timeForWork.day(i).format("dddd") + '</td>';
                                } else {
                                    html += '<td>' + timeForWork.day(0).format("dddd") + '</td>';
                                }
                            }
                        }
                        html += '</tr></table>'; 
                ...
                var placeCalendar = function(){
                    ...
                    $header = $calendar.find(".ic__header");
                    ...
                    if(settings.clickable) {
                        $day.on("click", function(e){
                            ...
                            if(settings.format.indexOf("L") >= 0) {
                                settings.startDate = timeSelected.format("");
                            } else {
